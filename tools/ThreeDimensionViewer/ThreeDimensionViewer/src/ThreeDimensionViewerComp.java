// -*- Java -*-
/*!
 * @file ThreeDimensionViewerComp.java
...
/*!
 * @class ThreeDimensionViewerComp
 * @brief Standalone component Class
 *
 */
public class ThreeDimensionViewerComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(ThreeDimensionViewer.component_conf);
      mgr.registerFactory(prop, new ThreeDimensionViewer(), new ThreeDimensionViewer());

      // Create a component
      RTObject_impl comp = mgr.createComponent("ThreeDimensionViewer");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        ThreeDimensionViewerComp init = new ThreeDimensionViewerComp();
