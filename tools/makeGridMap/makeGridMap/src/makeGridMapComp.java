...
/*!
 * @class makeGridMapComp
 * @brief Standalone component Class
 *
 */
public class makeGridMapComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(makeGridMap.component_conf);
      mgr.registerFactory(prop, new makeGridMap(), new makeGridMap());

      // Create a component
      RTObject_impl comp = mgr.createComponent("makeGridMap");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        makeGridMapComp init = new makeGridMapComp();
