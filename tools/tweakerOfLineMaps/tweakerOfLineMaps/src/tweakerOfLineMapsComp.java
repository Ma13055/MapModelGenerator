// -*- Java -*-
/*!
 * @file tweakerOfLineMapsComp.java
...
/*!
 * @class tweakerOfLineMapsComp
 * @brief Standalone component Class
 *
 */
public class tweakerOfLineMapsComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(tweakerOfLineMaps.component_conf);
      mgr.registerFactory(prop, new tweakerOfLineMaps(), new tweakerOfLineMaps());

      // Create a component
      RTObject_impl comp = mgr.createComponent("tweakerOfLineMaps");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        tweakerOfLineMapsComp init = new tweakerOfLineMapsComp();
