 ...
 * @brief ˆ—’†‚Ìƒ}ƒEƒX‘€ìî•ñ‚ğæ“¾‚·‚é
 * @date  $Date$
 *
 * @author —§ì«(Tatekawa Masaru)
...
/*!
 * @class controlPanelComp
 * @brief Standalone component Class
 *
 */
public class controlPanelComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(controlPanel.component_conf);
      mgr.registerFactory(prop, new controlPanel(), new controlPanel());

      // Create a component
      RTObject_impl comp = mgr.createComponent("controlPanel");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        controlPanelComp init = new controlPanelComp();
